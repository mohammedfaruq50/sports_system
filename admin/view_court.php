...
$stmt = mysqli_query($conn,"SELECT * FROM courts ORDER BY id ASC");
?>
...
<div class="container mt-4">
  <h2 class="mb-4 text-white">Courts List</h2>

  <a href="add_court.php" class="btn btn-success mb-3">Add Court</a>
  ...
  <table class="table table-bordered table-striped bg-white">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="delete_court.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this court?')">Delete</a>
        </td>
      </tr>
      <?php endwhile; ?>
    </tbody>
